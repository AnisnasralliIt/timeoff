...
const STATIC_MESSAGES: Record<string, string> = {
  ...
  "You cannot delete your own account.": "userRemoveSelf",
  "Only a SUPER_ADMIN can delete privileged users.": "onlySuperAdminRemovePrivileged",
  "This department is still in use — move its members and policies before deleting it.": "departmentInUse",
